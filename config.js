module.exports = {
    ...
    server: {
        guildId: '1309111843221929994',         // ايدي السيرفر
        broadcastRoleId: '1405587409189474335', // ايدي الرول اللي يستخدم عليها البوت
        reportChannelId: '1408181143726981129' // ايدي الروم اللي يرسل فيه البوت التقارير
    },
    broadcast: {
